...
#define CONFIG_CTX_GPIO 6
#define CONFIG_CRX_GPIO 7
#define CONFIG_EXAMPLE_I2C_ADDRESS_GND 1
#define CONFIG_EXAMPLE_INT_INPUT_PIN 9
#define CONFIG_EXAMPLE_I2C_MASTER_SCL 41
#define CONFIG_EXAMPLE_I2C_MASTER_SDA 42
